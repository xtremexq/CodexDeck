...
$files = @('Codex-Deck.ps1','Deck.Core.ps1','Deck.Commands.ps1','Deck.WarmupWorker.ps1','Deck.Background.vbs','Deck.GlobalRules.ps1','Deck.GlobalRules.cjs','Deck.Memories.ps1','Deck.AccountResources.ps1','Deck.Storage.ps1','Deck.Environments.ps1','Deck.BundledSkills.ps1','Deck.EnvironmentSettings.ps1','Deck.SkillSettings.ps1','Deck.AccountTools.ps1','Deck.Failover.ps1','Deck.Failover.cjs','Deck.Terminal.ps1','Deck.Backup.ps1','Deck.Crypto.cs','Deck.SettingsExtras.ps1','Deck.Theme.xaml','Run-CodexLoopUsage.cmd',
    ...
    'Test-DeckBundledSkills.ps1','deck/assets/codex-deck.png','deck/assets/codex-deck.ico','skills/debug-swarm/SKILL.md','skills/debug-swarm/agents/openai.yaml','skills/debug-swarm/.codexdeck.json')
$files += @('Deck.AutoCompact.cjs','Deck.AutoCompact.Sidecar.cjs','Test-DeckAutoCompact.cjs')
$wrappers = @('codex-auth.ps1','codex-auth.cmd','codex-check.cmd','codex-deck.cmd','codex-deck-session.ps1','codex-deck-session.cmd','account.cmd','pool.cmd','usage.cmd','check.cmd','deck.cmd')
...
. (Join-Path $suiteRoot 'Deck.BundledSkills.ps1')
