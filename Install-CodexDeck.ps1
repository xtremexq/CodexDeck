...
$files = @('Codex-Deck.ps1','Deck.Core.ps1','Deck.Commands.ps1','Deck.WarmupWorker.ps1','Deck.Background.vbs','Deck.ScheduledMessages.ps1','Deck.DelayedMessageWorker.ps1','Deck.ScheduledMessageWorker.ps1','Deck.GlobalRules.ps1','Deck.GlobalRules.cjs','Deck.Memories.ps1','Deck.AccountResources.ps1','Deck.Storage.ps1','Deck.Environments.ps1','Deck.BundledSkills.ps1','Deck.EnvironmentSettings.ps1','Deck.SkillSettings.ps1','Deck.AccountTools.ps1','Deck.Failover.ps1','Deck.Failover.cjs','Deck.Terminal.ps1','Deck.Backup.ps1','Deck.Crypto.cs','Deck.SettingsExtras.ps1','Deck.Theme.xaml','Run-CodexLoopUsage.cmd',
