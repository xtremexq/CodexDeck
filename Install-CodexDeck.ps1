...
$files = @('Codex-Deck.ps1','Deck.Core.ps1','Deck.GlobalRules.ps1','Deck.GlobalRules.cjs','Deck.Environments.ps1','Deck.EnvironmentSettings.ps1','Deck.AccountTools.ps1','Deck.Failover.ps1','Deck.Failover.cjs','Deck.Terminal.ps1','Deck.Backup.ps1','Deck.Crypto.cs','Deck.SettingsExtras.ps1','Deck.Theme.xaml','Run-CodexLoopUsage.cmd',
